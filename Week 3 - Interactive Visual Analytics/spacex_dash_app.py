...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        # create pie chart from filtered df
        fig = px.pie(site_data, 
                names='class',
                title=f'Launch Success Rate of {entered_site}')
    return fig
...
def get_scatter_chart(entered_site, payload_value):
    ...
    filtered_data = data[(data['Payload Mass (kg)'] >= low) & (data['Payload Mass (kg)'] <= high)]
    if entered_site=='ALL':
        ...
        site_data = filtered_data[filtered_data['Launch Site']==entered_site]
        fig = px.scatter(site_data, x='Payload Mass (kg)', y='class',
                color='Booster Version Category',
                title=f'Correlation between Payload and Success Rate in {entered_site}')
    return fig
